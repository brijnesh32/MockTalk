      ...
      <div className="container-fluid">
        ...
        <div className="collapse navbar-collapse justify-content-end" id="mocktalkNavbar">
          <ul className="navbar-nav mb-2 mb-md-0 me-xl-3">
            <li className="nav-item"><a className="nav-link h5" href="/about/">About</a></li>
            <li className="nav-item"><a className="nav-link h5" href="/blognew/">Blog</a></li>
            <li className="nav-item"><a className="nav-link h5" href="/docs/">Docs</a></li>
            <li className="nav-item"><a className="nav-link h5" href="/contact/">Contact</a></li>
            <li className="nav-item">
              <button className="login-button btn btn-primary" onClick={() => setIsLoginOpen(true)}>
                Login
              </button>
            </li>
          </ul>
